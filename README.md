...
PowerFox is a secure, modern, and open-source web browser for Mac OS X 10.6 Snow Leopard, 10.5 Leopard, 10.4 Tiger, and 10.3 Panther, based on the open-source UXP browser engine and Basilisk browser codebases.
...
## Support
If you would like to help the continued development of PowerFox, please consider supporting the project, which lets me acquire hardware for continual development and research further enhancements. Thank you to everyone who has supported the project so far!
